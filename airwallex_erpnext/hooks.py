...
scheduler_events = {
    "cron": {
        "*/5 * * * *": ["airwallex_erpnext.tasks.process_webhook_queue"],
        "17 * * * *": ["airwallex_erpnext.tasks.hourly_recovery"],
        "35 3 * * *": ["airwallex_erpnext.tasks.daily_recovery"],
    },
    "daily": ["airwallex_erpnext.tasks.cleanup_old_events"],
}

doc_events = {"Airwallex Settings": {"on_update": "airwallex_erpnext.events.settings_updated"}}
...
has_permission = {"Airwallex Settings": "airwallex_erpnext.permissions.settings_permission"}

website_route_rules = [{"from_route": "/airwallex/webhook", "to_route": "airwallex_erpnext.api.webhook"}]
